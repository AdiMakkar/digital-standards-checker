...
// urls in an array
var array = fs.readFileSync("accessibility_test.csv") // changed for test
                .toString().split("\n");
...
(async () => {
  ...
  fs.appendFileSync("accessibillity_test_results.csv", result.toString()); // created one for testing
  await chrome.kill();
})();